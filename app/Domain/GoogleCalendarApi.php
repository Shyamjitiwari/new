...
class GoogleCalendarApi{
	...
	public function CreateCalendarEvent($calendar_id, $summary, $description, $all_day, $event_time, $event_timezone, $access_token, $invitee) {
		$url_events = 'https://www.googleapis.com/calendar/v3/calendars/' . $calendar_id . '/events?conferenceDataVersion=1&sendNotifications=true';
		...
		$curlPost['attendees'] = array(array('email' => $invitee));
		$curlPost['sendNotifications'] = array(true);
		  
		  
		$str=rand(); 
	    $randomstring = md5($str); 
		$curlPost['conferenceData'] = array('createRequest' => array('requestId' => "7qxalsvy0e"));
