<template>
    <div>
        <h3 v-if="!isEditable">Add Blog</h3>
        <h3 v-else>Edit Blog</h3>
        <form id="createUser" @submit.prevent="createBlog()" enctype="multipart/form-data">
           <div class="row">
               <div class="col-md-8">
                   <div class="row">
                       <div class="col">
                       ...
                       <div class="col">
                           <div class="form-group">
                               ...
                               <input type="text" v-model="blog.alt" class="form-control" placeholder="Image Alt Text..."/>
                           </div>
                       </div>
                   </div>
                   <div class="row">
                       <div class="col">
                           <div class="form-group">
                               <label>Name</label>
                               <input type="text" v-model="blog.name" class="form-control" placeholder="Name..."/>
                        ...
                        <div class="col" v-if="isEditable">
                           <div class="form-group">
                               <label>Slug</label>
                               <input type="text" v-model="blog.slug" class="form-control" placeholder="Name..."/>
                   ...
                   <div class="row">
                       <div class="col">
                           <div class="form-group">
                               ...
                               <select class="form-control" v-model="blog.created_id" required>
                       ...
                       <div class="col" v-if="!isEditable">
                           <div class="form-group">
                               ...
                               <input type="date" v-model="blog.created_at" class="form-control" placeholder="Date..." required/>
                       ...
                       <div class="col">
                           <div class="form-group">
                               ...
                               <input type="number" v-model="blog.read_time" class="form-control" placeholder="Read Time..."/>
                           </div>
                       </div>
                   </div>
                   <div class="row">
                       <div class="col">
                           <div class="form-group">
                               ...
                               <div>
                                    <tinymce  id="d1"  v-model="blog.description"></tinymce>
                               </div>
               ...
               <div class="col-md-4">
                   ...
                   <div class="row">
                       <div class="col">
                           <button type="button" class="btn btn-sm bg-primary m-1 text-white" v-for="tag in blog.tags" :key="tag.id">
                               {{tag.name}}
                    ...
                    <div class="row">
                        <div class="col-md-12" v-if="blog.image">
                            <img :src="'/images2/'+blog.image.image.folder+'/'+blog.image.image.name" :alt="blog.image.image.alt" style="width:100%">
                   ...
                   <div class="row">
                       <div class="col-md-12">
                           <div class="form-group">
                               <label>Title</label>
                               <input type="text" v-model="blog.meta_title" class="form-control" placeholder="Meta Title..."/>
                           </div>
                       </div>
                       <div class="col-md-12">
                           <div class="form-group">
                               <label>Keywords</label>
                               <input type="text" v-model="blog.meta_keywords" class="form-control" placeholder="Meta Keywords..."/>
                           </div>
                       </div>
                       <div class="col-md-12">
                           <div class="form-group">
                               <label>Meta Description</label>
                               <textarea rows="5" v-model="blog.meta_description" class="form-control" placeholder="Description..."></textarea>
                           </div>
                       </div>
                   </div>
               </div>
...
<script>
    ...
    export default {
        ...
        data(){
         ...
         mounted(){
                tinymce1.get("d1").setContent(this.blog.description);
        },
        created() {
        ...
        computed: {
            ...mapGetters(["getErrors", 'getActiveCategories', 'getActiveTags', 'getActiveUsers', "isEditable"]),
        },
        methods : {
            ...
            updateTags(tag){
                ...
                } else if(!this.isDuplicate(tag,  this.blog.tags)) {
                    this.blog.tags.push(tag);
                }
                this.selectTag = {};
            },
            ...
            getImage(e){
                ...
                fileReader.onload = (e) => {
                    this.blog.image_name = e.target.result;
                }
            },
            removeImage(){
                if(confirm('Are you sure you want to delete this imahe?')){
                    this.$store.dispatch('removeImage', this.blog);
                }
            },
            createBlog() {
                this.$store.dispatch("dispatchCreateBlog", {
                    'blog': this.blog,
                });
            },
            reset(){
