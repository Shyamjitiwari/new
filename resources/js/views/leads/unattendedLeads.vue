<template>
    <div>
        <page-title
            :title="'Unattended Leads (Count : ' + this.getUnattendedLeadsCount + ')'"
...
<!--                        </div>-->
        ...
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <table class="table table-sm">
                                ...
                                <tr class="font-weight-bolder bg-warning" v-for="lead in getUnattendedLeadsForToday" :key="lead.id" v-if="getUnattendedLeadsForToday.length">
                                    <td></td>
                                    <td>
                                ...
                                <tr
                                    v-for="(lead) in getUnattendedLeads.data" :key="lead.id"
                ...
                <br />
                <pagination show=4 :data="getUnattendedLeads" @updatePagination="updatePagination"> </pagination>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(["getUnattendedLeads", "getErrors", "getSearchFilter", 'getAuth', 'getUnattendedLeadsCount', 'hasPermission', 'getUnattendedLeadsForToday']),

            reload(){
                return {type : 'fetchUnattendedLeads', payload : {next_page: this.getUnattendedLeads.current_page, search: this.search}};
            },
            showBulkAction(){
        ...
        created() {
            ...
            this.$store.dispatch("fetchUnattendedLeads", {
                next_page: this.getUnattendedLeads.current_page,
                search: this.search
            });
        },
        ...
        methods: {
            ...
            reset() {
                ...
                this.$router.push({ name: 'unattendedLeads'});
                this.search =  {
                    name: "",
                    mobile: "",
                    email: "",
