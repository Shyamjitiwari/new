            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body m-0">
                        <form id="createProject" @submit.prevent="createProject(project)" enctype="multipart/form-data">
                            <div class="row">
                               ...
                               <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control" v-model="project.location_id">
                                 ...
                                 <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                       ...
                                       <select class="form-control" v-model="project.builder_id">
                                            <option selected disabled value="">Select Builder</option>
                                   ...
                                   <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="nearby_location">Nearby Location</label>
                                         <select class="form-control" v-model="project.nearby_location_id">
                                            <option disabled selected value="">Select NearBy Location</option>
                                            <option v-for="location in getLocations" :value="location.id" :key="location.id">{{location.name}}</option>
                                        </select>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input
                                            type="text"
                                            v-model="project.distance_in_kms"
                                            class="form-control"
                                            id="distane_in_kms"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(["getErrors", "getMessage",  "getLocations", "getBuildersActive", "hasPermission"])
        },
        created() {
            this.project = {
                'location_id': "",
        ...
        methods: {
            createProject(project) {
                this.$store.dispatch("dispatchCreateProject",project);
