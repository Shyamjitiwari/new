...
<html lang="en">
    <head>
        ...
        <meta name="keywords" content="codewithus,coding,classes">
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-145736914-2"></script>
        <!-- Intercom livechat -->
		<script>
...
@yield('additional_facebook_pixel_code')
    </head>
