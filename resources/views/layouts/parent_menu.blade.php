    ...
    <div class="xp-sidebar">
        ...
        <div class="xp-navigationbar">
            <ul class="xp-vertical-menu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <i class="fa fa-dollar"></i><span>Billing</span><i class="icon-arrow-right pull-right"></i>
                    </a>
                    <ul class="xp-vertical-submenu">                                
                        <li><a href="{{url('/plans')}}">Purchase Classes</a></li>        
                        <li><a href="{{url('/billing_history')}}">Past Payments</a></li>  
                    </ul>
                </li>            
