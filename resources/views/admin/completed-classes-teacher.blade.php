@section('title')
    CodeWithUs - Completed Classes for Teacher
@endsection
...
@section('rightbar-content')
    ...
    <div class="xp-breadcrumbbar">
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <h4 class="xp-page-title">Completed Classes Teacher</h4>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="xp-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Completed Classes Teacher</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="xp-contentbar">
        <div class="row">
            <div class="col-lg-12">
                <div id="app_vue">
                    <completed-classes-teacher :teacher_id="'{{ $id }}'"> </completed-classes-teacher>
                </div>
            </div>
        </div>
    </div>
