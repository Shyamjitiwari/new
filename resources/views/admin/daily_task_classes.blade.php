...
@section('rightbar-content')
    ...
    <div class="xp-breadcrumbbar">
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <h4 class="xp-page-title">Daily Classes</h4>
            </div>
            <div class="col-md-6 col-lg-6">
                <div class="xp-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="icon-home"></i></a></li>
                        <li class="breadcrumb-item active" aria-current="page">Daily Classes</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="xp-contentbar">
        <div id="app_vue">
            <daily-task-classes> </daily-task-classes>
        </div>
    </div>
    <!-- End XP Contentbar -->
@endsection
