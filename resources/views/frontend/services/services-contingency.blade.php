            ...
            <div class="row whitebox top15">
                ...
                <div class="bglight position-relative" style="max-width: 100%;">
                    <div class="widget heading_space text-center text-md-left">
                        ...
                        <p class="bottom30">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu,
                            lobortis id interdum vitae, interdum eget elit. Curabitur quis urna nulla. Suspendisse
                            potenti. Duis suscipit ultrices maximus. </p>
                        <p class="bottom30">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
