...
<style>
    ...
    .vuecal__event.sport {margin-bottom:5px ;background-color: rgba(255, 102, 102, 0.9);border: 1px solid rgb(235, 82, 82);color: #fff;}
    .vuecal__event.bg-info {margin-bottom:5px ;}
</style>
@section('leftbar')
    ...
    <div class="xp-breadcrumbbar">
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <h4 class="xp-page-title">Schedule</h4>
            </div>
            <div class="col-md-6 col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <h3 style="color:black">{!! __('instructions.reschedule_rule_title') !!}</h3>
                        <ol>
                            <li>{!! __('instructions.reschedule_rule_1') !!}</li>
                            <li>{!! __('instructions.reschedule_rule_2') !!}</li>
                            <li>{!! __('instructions.reschedule_rule_3') !!}</li>
                        </ol>
                        <hr><br/>
                        <div id="app_vue">
                            <student-task-class-reschedule
                                    :student="{{$student}}"
                                    :taskclass="{{$taskclass}}"
                            > </student-task-class-reschedule>
                        </div>
